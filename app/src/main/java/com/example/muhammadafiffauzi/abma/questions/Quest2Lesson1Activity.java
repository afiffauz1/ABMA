...
public class Quest2Lesson1Activity extends AppCompatActivity {
    ...
    private void saveScore(String id, String score){
        Question2Model question2Model = new Question2Model(id, score);
